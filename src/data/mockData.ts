...
const basePeople: Person[] = [
  { personID: 'PER-0001', name: 'Radha Krishna Das', phone: '9845012345', email: 'rkdas@example.com', address: '12 Main Road', city: 'Bengaluru', personType: ['Donor', 'Devotee'], joinDate: '2025-11-01', status: 'active', notes: 'Major donor, temple committee member', birthday: '1968-10-21', anniversary: '1990-12-12', preferredChannel: 'WhatsApp', panNumber: 'ABCDE1234F', aadhaarNumber: '123456789012' },
  { personID: 'PER-0002', name: 'Madhumati Devi Dasi', phone: '9987654321', email: 'madhumati@example.com', address: '45 Lake View', city: 'Mysuru', personType: ['Donor', 'Devotee'], joinDate: '2025-11-15', status: 'active', notes: '', birthday: '1972-09-15', preferredChannel: 'Email', panNumber: 'FGHIJ5678K', aadhaarNumber: '234567890123' },
